...
- **On an iPhone, the bottom bar floats.** The tab bar, and a page's
  ...
  iOS 26 gives its own apps. The bar is icons only; scrolling down
  ...
  in grouped lists with a chevron on each, switches are the platform's
  own, and a sheet rising from the bottom is glass too. Android and the desktop keep the docked bar.
...
- **The game page's opening name keeps its size.** The line over the
...
- **Several games at once.** “Select…” beside the collection's count
...
no longer scrolls under the app on the puzzle dashboard, the
sidebar's icons stay where they are when it folds, and the editor's
...
- **The databases browser hunts by motif.** “Search by” gains Motif
  ...
  fianchetto, a knight outpost and the opposite-coloured-bishop ending
