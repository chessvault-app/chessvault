...
A **page change is a cut**, on every viewport. The phone had a fade for
a tab switch and a slide for a push and a pop, chosen against the two
platform guides and measured; in use, the fade read as the screen
flickering and the three were taken out together (2026-09-13). A page
that turns INSIDE a window still slides, since the sheet stays and the
turn is what the eye is following.
