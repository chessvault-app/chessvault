...
- **PWA**: 브라우저에서 설치한 같은 웹 앱입니다. 매니페스트 + 서비스
  ...
  창만 지연 로딩되는 것도 같은 이유입니다. 0.7.2 빌드에서 시작 페이지가 받는 JS는
  한국어로 662 kB였습니다. 셸 563 kB(49개 조각: 248 kB의 진입 조각, 133 kB의
  컴포넌트 층, 63 kB의 다이얼로그)에 사전 99 kB이고, 영어로는 563 kB였습니다. 컴포넌트 층이 들어오기 전의 셸은 217 kB였고,
