...
- **PWA**: 브라우저에서 설치한 같은 웹 앱입니다. 매니페스트 + 서비스
  ...
  한국어로 619 kB입니다 — 셸 516 kB(44개 조각: 233 kB의 진입 조각, 129 kB의
  컴포넌트 층, 61 kB의 다이얼로그)에 사전 102 kB — 영어로는 516 kB이고,
  0.6.0 빌드에서 쟀습니다. 컴포넌트 층이 들어오기 전의 셸은 217 kB였고,
  ...
  코드이기 때문입니다. 컴포넌트 층과 다이얼로그 조각은 움직이지 않았습니다.
