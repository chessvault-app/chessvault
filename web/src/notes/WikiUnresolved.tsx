              ...
              return (
                <li key={`${section}:${id}`}>
                  <button
                    ...
                    className="hover:bg-accent flex w-full items-center gap-1.5 rounded-md px-2 py-(--row-py) text-left type-row"
                  >
          ...
          CREATE_ORDER.map((section) => {
            ...
            return (
              <button
                ...
                className="hover:bg-accent flex w-full items-center gap-1.5 rounded-md px-2 py-(--row-py) text-left type-row disabled:opacity-50"
              >
