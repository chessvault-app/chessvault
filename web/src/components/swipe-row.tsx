 ...
 * before, with the axis lock below standing the row down. The axis lock
 * still stands the row down on a second finger, which is what a reader
 * spreading two fingers over a list does before the app declines it.
 */
