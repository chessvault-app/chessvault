...
/**
 * shadcn's Popover, owned: an anchored floating card with a focus scope,
 * outside-press and Escape dismissal, and collision-aware placement —
 * Radix's. The face is the app's popover face (shadow-pop, the border).
 */
  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          'border-border bg-popover text-popover-foreground z-50 flex w-72 origin-(--radix-popover-content-transform-origin) flex-col gap-2.5 rounded-lg border p-2.5 text-sm shadow-pop outline-hidden duration-100',
