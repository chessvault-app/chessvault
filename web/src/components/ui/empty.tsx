...
// fill and its rounding go, the box grows to 48px and holds a 40px
// symbol in the muted ink the description below is already in. The box
// draws nothing once the fill is gone, so its 4px of padding is not air
// around a shape; it is the space above the title, which is the only
// direction an invisible box has. It is kept as padding rather than
// folded into that gap so the box stays a box: a tile whose glyph runs
// to all four edges has nothing left to tune.
//
...
// the ink: a 48px symbol measured 4px of stroke against 1px at the
...
// presentational attribute at any specificity; the padding needs none
// either, replacing nothing. Nothing else about the
  ...
  "mb-2 flex shrink-0 items-center justify-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        icon: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-muted text-foreground [&_svg:not([class*='size-']):not([class*='glyph'])]:size-4 ios:size-12! ios:p-1 ios:rounded-none! ios:bg-transparent! ios:text-muted-foreground! ios:[&_svg:not([class*='size-']):not([class*='glyph'])]:size-10! ios:[&_svg:not([class*='size-']):not([class*='glyph'])]:[stroke-width:1.4]",
      },
    },
    defaultVariants: {
      variant: "default",
