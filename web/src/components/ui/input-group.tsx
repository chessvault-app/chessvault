...
const inputGroupAddonVariants = cva(
  "flex h-auto cursor-text items-center justify-center gap-2 py-1.5 text-sm max-md:type-row font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-']):not([class*='glyph'])]:size-4",
  {
    variants: {
      align: {
...
const inputGroupButtonVariants = cva('flex items-center gap-2 text-sm max-md:type-row shadow-none', {
  variants: {
    size: {
