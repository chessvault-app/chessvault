...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        'mb-1.5 font-medium data-[variant=label]:text-sm max-md:data-[variant=label]:type-row data-[variant=legend]:text-base',
        className,
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        'flex w-fit items-center gap-2 text-sm max-md:type-row font-medium group-data-[disabled=true]/field:opacity-50',
        className,
      )}
      {...props}
    />
