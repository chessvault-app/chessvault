...
function cyclesProse(nudge: boolean): string {
  const invite = t('Work the whole book in passes — every puzzle once per cycle, scored by first attempts. Each pass should come out faster and cleaner than the one before.');
