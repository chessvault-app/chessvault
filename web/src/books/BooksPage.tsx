...
import { BookMarked, ScanSearch, BookOpen, BookText, Bookmark, FileUp, Folder as FolderIcon, FolderInput, Pencil, SearchX, Trash2, X } from 'lucide-react';
      ...
      <ShelfToolbar
        ...
        create={
          <CreateControl
            ...
            label="Import"
            actions={[
              { label: 'Import a PDF', icon: FileUp, onSelect: () => setAdding({ file: null }) },
