...
export const ko: Record<string, string> = {
  ...
  'The workspace needs a window wide enough for the board, the moves, the explorer and the games browser side by side. On this screen each pane is a page of its own.':
    '워크스페이스는 보드, 수순, 탐색기, 게임 브라우저를 나란히 놓을 만큼 넓은 창이 필요합니다. 이 화면에서는 각 창이 저마다의 페이지로 열립니다.',
  Repertoire: '레퍼토리',
  Dashboard: '대시보드',
  Books: '책',
  Themes: '테마',
  ...
  'End (↓)': '끝 (↓)',
  'End (End)': '끝 (End)',
  'Loaded a game over your line': '내 라인 위에 게임을 불러왔습니다',
  ...
  'Load a position from FEN, PGN or an image': 'FEN, PGN 또는 이미지에서 포지션 불러오기',
  ...
  'Unlinked mentions': '연결되지 않은 언급',
  Link: '연결',
  'Only the first {n} are shown.': '처음 {n}개만 표시합니다.',
  'Which one?': '어느 쪽인가요?',
  '{n} more, keep typing': '{n}개 더 있습니다. 계속 입력하세요',
  ...
  'Search games…': '게임 검색…',
  'Paste a PGN here. A Lichess study export brings its chapters, comments and arrows.':
    '여기에 PGN을 붙여넣으세요. Lichess 스터디 내보내기는 챕터, 주석, 화살표까지 함께 들어옵니다.',
  ...
  'Rename this folder': '이 폴더 이름 바꾸기',
  '{n} KB': '{n} KB',
  // Shelf toolbar: order, layout and pinning.
  'Sort by': '정렬 기준',
  ...
  'The games worth keeping, each annotatable like a study. Import one, or add games from your online archive.':
    '남길 만한 게임을 모아 두는 곳이며, 각 게임에 스터디처럼 주석을 달 수 있습니다. 게임을 가져오거나, 온라인 기보에서 추가하세요.',
  'No bookmarked games yet': '즐겨찾기한 게임이 없습니다',
  'Browse all games': '모든 게임 보기',
  'No studies yet': '아직 스터디가 없습니다',
  'A study is a set of annotated chapters, kept as plain PGN. Start an empty one, or import a PGN you already have.':
    '스터디는 주석이 달린 챕터들의 묶음이며, 평범한 PGN으로 저장됩니다. 빈 스터디로 시작하거나, 가지고 있는 PGN을 가져오세요.',
  ...
  'A note is plain markdown with interactive boards anywhere in the text. An idea, a plan, a game to come back to.':
  ...
  'The side not to move is in check. Switch whose turn it is.':
    '차례가 아닌 쪽이 체크 상태입니다. 차례를 바꿔 주세요.',
  'Exact position': '정확한 포지션',
  'Same pawns & material': '같은 폰 배치·같은 기물',
  'Same pawn files & material': '같은 폰 파일·같은 기물',
  'Same pawn structure': '같은 폰 구조',
  'Same material': '같은 기물 구성',
  'How long it must hold': '유지 기간',
  'At any moment': '한 순간이라도',
  ...
  'Double rook endgame': '더블 룩 엔드게임',
  'Rook and bishop endgame': '룩+비숍 엔드게임',
  'Rook and knight endgame': '룩+나이트 엔드게임',
  'Rook and pawns vs rook': '룩+폰 대 룩',
  'Rook vs pawns': '룩 대 폰',
  'Queen vs rook': '퀸 대 룩',
  'Queen vs two rooks': '퀸 대 룩 둘',
  'Queenless middlegame': '퀸 없는 미들게임',
  'Major pieces only': '메이저 기물만',
  'A pawn up': '폰 하나 우위',
  'Two pawns up': '폰 둘 우위',
  'A minor piece up': '마이너 하나 우위',
  'Exchange up': '익스체인지 우위',
  'A rook up': '룩 하나 우위',
  'Two minors vs rook': '마이너 둘 대 룩',
  'A queen up': '퀸 하나 우위',
  'Bishop pair vs bishop and knight': '비숍 쌍 대 비숍+나이트',
  'Bishop pair vs two knights': '비숍 쌍 대 나이트 둘',
  'Rook and bishop vs rook and knight': '룩+비숍 대 룩+나이트',
  'Three minor pieces vs queen': '마이너 셋 대 퀸',
  'Custom…': '직접 지정…',
  ...
  'Closed Ruy Lopez': '클로즈드 루이 로페즈',
  'Exchange Ruy Lopez': '익스체인지 루이 로페즈',
  'Philidor centre': '필리도르 중앙',
  'Symmetrical d-pawn centre': '대칭 d폰 중앙',
  ...
  Winawer: '비나베르',
  'Caro-Kann': '카로칸',
  'Advance Caro-Kann': '어드밴스 카로칸',
  Pirc: '피르츠',
  "Queen's Gambit Declined": '퀸스 갬빗 거절',
  'Carlsbad structure': '카를스바트 구조',
  Slav: '슬라브',
  'Semi-Slav triangle': '세미슬라브 삼각형',
  Catalan: '카탈란',
  'London System': '런던 시스템',
  Stonewall: '스톤월',
  'Leningrad Dutch': '레닌그라드 더치',
  'Nimzo-Indian doubled pawns': '님조인디안 더블 폰',
  'Grünfeld exchange centre': '그륀펠트 익스체인지 중앙',
  ...
  '{pct}% of games. No answer in the study.': '게임의 {pct}%. 스터디에 답이 없습니다.',
  ...
  'Whole study': '스터디 전체',
  'This study has no moves yet, so there is nothing to drill.':
  ...
  'Unclear position': '불명확한 형세',
  'White is slightly better': '백이 약간 우세',
  'Black is slightly better': '흑이 약간 우세',
  'White is better': '백이 우세',
  'Black is better': '흑이 우세',
  'White is winning': '백이 승세',
  'Black is winning': '흑이 승세',
  'All games': '모든 게임',
  'All studies': '모든 스터디',
  'Notes on this game…': '이 게임에 대한 메모…',
  'Chapter introduction…': '챕터 소개…',
  'Delete this chapter (its sub-chapters move to the top level)': '이 챕터 삭제 (하위 챕터는 최상위로 올라갑니다)',
  'Delete this chapter': '이 챕터 삭제',
  ...
  'Import a tactics book you own from its PDF.': '갖고 있는 전술책의 PDF에서 가져오세요.',
  'Missed puzzle': '놓친 퍼즐',
  ...
  'Queen and major pieces': '퀸과 메이저 기물',
  ...
  'Play a random ending against the tablebase: keep a win, or hold a draw. A move that lets the result slip ends the attempt and shows the move that kept it.':
    '무작위 엔드게임을 테이블베이스를 상대로 둡니다. 승리를 지키거나 무승부를 지킵니다. 결과를 놓치는 수를 두면 시도가 끝나고, 결과를 지키는 수를 보여 줍니다.',
  'Finding an ending…': '엔드게임을 찾는 중…',
  ...
  'No position of this material with something to keep turned up this time.':
    '이번에는 이 기물 구성에서 지킬 것이 있는 위치가 나오지 않았습니다.',
  ...
  'Searches positions whose printed solution would not replay, and imports them labelled by how much is known. Adds a few seconds per hundred.':
    '인쇄된 정답이 재생되지 않은 포지션을 엔진이 탐색하고, 얼마나 알아냈는지 표시를 달아 가져옵니다. 백 개마다 몇 초씩 더 걸립니다.',
  ...
  'This database’s sums are not split by level, so all of its games are shown.':
    '이 데이터베이스의 합계는 레벨로 나뉘어 있지 않아 전체 게임을 보여 줍니다.',
  'None, hide gaps': '없음, 갭 숨기기',
  ...
  'Checking…': '확인 중…',
  'This is the newest build.': '최신 빌드입니다.',
  'Not a packaged build.': '패키징된 빌드가 아닙니다.',
  ...
  'the update feed refused the request': '업데이트 피드가 요청을 거부했습니다',
  ...
  Corners: '모서리',
  Glass: '유리',
  'How much of the page shows through bars and menus. At zero they are solid.':
    '바와 메뉴 너머로 페이지가 얼마나 비칠지 정합니다. 0에서는 불투명해집니다.',
  'Glass tint': '유리 명도',
  'How dark the glass itself is. It has its own range in each theme.':
    '유리 자체가 얼마나 어두운지 정합니다. 테마마다 범위가 따로 있습니다.',
  Default: '기본',
  Square: '각진',
  ...
  'Previous / next move': '이전 / 다음 수',
  'Go to the start': '처음으로',
  'Go to the end': '끝으로',
  'Flip the board': '보드 뒤집기',
  'Play the typed move (in the move box)': '입력한 수 두기 (수 입력 칸에서)',
  'Close the open window': '열린 창 닫기',
  'This list': '이 목록',
  'No theme matches it.': '일치하는 테마가 없습니다.',
  '{n} of {total} themes match': '테마 {total}개 중 {n}개 일치',
  '{wins}/{tries} tries': '{tries}회 시도, {wins}회 성공',
  ...
  'Private instance. Every game, study and puzzle here lives in plain files on its owner’s server.':
    '개인 인스턴스입니다. 여기의 모든 게임, 스터디, 퍼즐은 소유자의 서버에 평범한 파일로 저장됩니다.',
  'No password is set, so anyone who can reach this server sees everything. Setting one turns the lock screen on.':
    '비밀번호가 설정되어 있지 않아, 이 서버에 접근할 수 있는 누구나 모든 것을 볼 수 있습니다. 설정하면 잠금 화면이 켜집니다.',
  ...
  'Reviewing, not counted. Each clean solve spaces the puzzle further out, and enough in a row retire it.':
    '복습 중이며, 기록에 세지 않습니다. 깔끔하게 풀 때마다 다음 복습이 멀어지고, 연달아 충분히 풀면 목록에서 빠집니다.',
  'Replaying puzzle #{id}, not counted. A clean solve still retires it from the review list.':
    '#{id} 퍼즐을 다시 푸는 중이며, 기록에 세지 않습니다. 깔끔하게 풀면 복습 목록에서 빠집니다.',
  ...
  'Import the book’s PDF and the reader takes the diagrams and printed solutions off its pages, pausing and resuming as you like. Or set a position up by hand and record the full solution.':
    '책의 PDF를 가져오면 페이지에서 다이어그램과 인쇄된 정답을 읽어 오며, 멈췄다가 이어서 할 수 있습니다. 또는 직접 포지션을 만들고 정답을 기록해도 됩니다.',
  ...
  'Import a scanned tactics book and its diagrams become puzzles':
    '스캔한 전술 책을 가져오면 다이어그램이 풀 수 있는 퍼즐이 됩니다',
  ...
  'Align the map': '화면에 맞추기',
  'Show the tree': '트리로 보기',
  'Show the constellation': '별자리로 보기',
  'New folder': '새 폴더',
  ...
  "The book's exact solution, parsed and verified or entered by hand":
    '책에 있는 그대로의 정답으로, 해석해 검증했거나 직접 입력한 것',
  'Engine + book': '엔진 + 책',
  ...
  'Could not load the next puzzle.': '다음 퍼즐을 불러오지 못했습니다.',
  'Could not load the missed puzzle.': '놓친 퍼즐을 불러오지 못했습니다.',
  ...
  'could not reach Lichess': 'Lichess에 접속하지 못했습니다',
  'import failed': '가져오기에 실패했습니다',
  "Lichess is unreachable": "Lichess에 접속할 수 없습니다",
  "No failed puzzles to review. Nothing to fix.": "다시 볼 틀린 퍼즐이 없습니다. 고칠 것이 없습니다.",
  "No puzzle matches that filter.": "그 조건에 맞는 퍼즐이 없습니다.",
  ...
  "enter a code from your current authenticator first": "먼저 현재 인증 앱의 코드를 입력하세요",
  "expected a jpeg/png data URL": "jpeg/png 데이터 URL이어야 합니다",
  "expected white & black": "백과 흑이 필요합니다",
  "index out of range": "범위를 벗어난 번호입니다",
  "invalid FEN": "잘못된 FEN입니다",
  "invalid Lichess username": "잘못된 Lichess 사용자명입니다",
  "invalid folder name": "잘못된 폴더 이름입니다",
  "no such folder": "그런 폴더가 없습니다",
  "invalid file": "잘못된 파일입니다",
  "invalid month": "잘못된 달입니다",
  "invalid name": "잘못된 이름입니다",
  "invalid profile": "잘못된 프로필입니다",
  "invalid secret": "잘못된 비밀키입니다",
  "invalid study id": "잘못된 스터디 id입니다",
  "invalid username": "잘못된 사용자명입니다",
  "study too large": "스터디가 너무 큽니다",
  "that PGN could not be read": "그 PGN을 읽지 못했습니다",
  "that code does not match, scan the QR again and retype": "코드가 맞지 않습니다. QR을 다시 스캔하고 입력하세요",
  "that does not look like a Lichess token": "Lichess 토큰 형식이 아닙니다",
  "too many attempts, try again later": "시도가 너무 많습니다. 잠시 후 다시 시도하세요",
  "unknown book": "알 수 없는 책입니다",
  "unknown diagram": "알 수 없는 다이어그램입니다",
  "unknown draft": "알 수 없는 초안입니다",
  "unknown explorer database": "알 수 없는 탐색기 데이터베이스입니다",
  "unknown game": "알 수 없는 게임입니다",
  "unknown puzzle": "알 수 없는 퍼즐입니다",
  "vault configuration error": "보관함 설정 오류입니다",
  "wrong authenticator code": "인증 앱 코드가 틀렸습니다",
  "wrong password": "비밀번호가 틀렸습니다",
  "no such file": "그런 파일이 없습니다",
  "no such game": "그런 게임이 없습니다",
  "no such book": "그런 책이 없습니다",
  ...
  "New study": "새 스터디",
  "Import PGN as study": "PGN을 스터디로 가져오기",
  "Study name": "스터디 이름",
  "Note": "노트",
  "Study": "스터디",
  "(no folder)": "(폴더 없음)",
  ...
  "Arabian mate": "아라비안 메이트",
  "Attacking f2/f7": "f2/f7 공격",
  "Attraction": "유인",
  "Back rank mate": "백랭크 메이트",
  "Balestra mate": "발레스트라 메이트",
  "Bishop endgame": "비숍 엔드게임",
  "Blind swine mate": "블라인드 스와인 메이트",
  "Boden mate": "보덴 메이트",
  "Capturing defender": "수비수 잡기",
  "Clearance": "길 열기",
  ...
  "Double bishop mate": "더블 비숍 메이트",
  "Double check": "더블 체크",
  "Dovetail mate": "도브테일 메이트",
  "En passant": "앙파상",
  "Endgame": "엔드게임",
  "Epaulette mate": "에폴렛 메이트",
  "Equality": "균형",
  "Exposed king": "노출된 킹",
  "Fork": "포크",
  ...
  "Interference": "차단",
  "Intermezzo": "중간 수",
  "Kill box mate": "킬 박스 메이트",
  "Kingside attack": "킹사이드 공격",
  "Knight endgame": "나이트 엔드게임",
  "Long": "긴 풀이",
  "Master": "마스터 게임",
  "Master vs master": "마스터 대 마스터",
  "Master games": "마스터 게임",
  "Mate": "메이트",
  "Mate in 1": "1수 메이트",
  "Mate in 2": "2수 메이트",
  ...
  "Mate in 5": "5수 메이트",
  "Middlegame": "미들게임",
  "Morphy's mate": "모피 메이트",
  "One move": "한 수",
  "Opera mate": "오페라 메이트",
  "Pawn endgame": "폰 엔드게임",
  "Pillsbury's mate": "필스버리 메이트",
  "Pin": "핀",
  "Promotion": "승격",
  "Queen endgame": "퀸 엔드게임",
  "Queen rook endgame": "퀸+룩 엔드게임",
  "Queenside attack": "퀸사이드 공격",
  "Quiet move": "조용한 수",
  "Rook endgame": "룩 엔드게임",
  "Sacrifice": "희생",
  "Short": "짧은 풀이",
  "Skewer": "스큐어",
  "Smothered mate": "질식 메이트",
  "Super-GM games": "슈퍼 GM 게임",
  "Swallow's tail mate": "스왈로테일 메이트",
  "Trapped piece": "갇힌 기물",
  "Triangle mate": "트라이앵글 메이트",
  "Under promotion": "언더프로모션",
  "Very long": "아주 긴 풀이",
  "Vukovic mate": "부코비치 메이트",
  "X-ray attack": "X레이 공격",
  "Zugzwang": "추크츠방",
  ...
  'Every version of every document is kept automatically. Anything deleted can be brought back here. An open document keeps its earlier versions under the clock in its header.':
    '모든 문서의 모든 버전이 자동으로 보관됩니다. 삭제된 문서는 여기서 되살릴 수 있습니다. 열려 있는 문서의 이전 버전은 머리글의 시계 아이콘에 있습니다.',
  ...
  '{n} found, page {page}': '{n}개 찾음, {page}쪽',
  '{k} of {n}, page {page}': '{n}개 중 {k}번째, {page}쪽',
  'Diagram reading finished.': '다이어그램 읽기가 끝났습니다.',
  'Diagram reading failed.': '다이어그램 읽기에 실패했습니다.',
  'Book title': '책 제목',
  ...
  'Type an opening name': '오프닝 이름을 입력하세요',
  'Type an ECO code, like B90 or C6': 'B90, C6 같은 ECO 코드를 입력하세요',
  'Type an event name': '대회 이름을 입력하세요',
  'Type a year or a span, like 2014 or 2010-2015': '2014나 2010-2015처럼 연도 또는 범위를 입력하세요',
  'needs a value': '값이 필요합니다',
  'is not a result. Use 1-0, 0-1 or draw': '은(는) 결과가 아닙니다. 1-0, 0-1 또는 draw를 쓰세요',
  ...
  'That outcome and that result can never happen in the same game, so no game will match.':
    '그 승패와 그 결과는 한 게임에서 동시에 성립할 수 없으므로 일치하는 게임이 없습니다.',
  ...
  'Not recorded': '기록 없음',
  'Game length': '게임 길이',
  'Results by how many moves the game ran.': '게임이 몇 수까지 이어졌는지별 성적입니다.',
  'By length': '길이별',
