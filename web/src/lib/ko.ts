...
export const ko: Record<string, string> = {
  ...
  'Accuracy': '정확도',
  "How close your moves came to the engine's, on the scale Lichess and chess.com use. Book moves are not judged.": '내 수가 엔진의 수에 얼마나 가까웠는지를 Lichess와 chess.com이 쓰는 척도로 재었습니다. 이론 수는 판정하지 않습니다.',
  '{n} of {total} games analysed at depth {d}': '게임 {total}개 중 {n}개를 깊이 {d}로 분석',
  ...
  'By month': '월별',
  'Move quality': '수의 질',
  "Every move you played in the analysed games, by the engine's verdict.": '분석한 게임에서 내가 둔 모든 수를 엔진의 판정별로 묶었습니다.',
  'Verdict': '판정',
  'Share': '비율',
  'Brilliant': '명수',
  'Good': '좋은 수',
